class UsersController < ApplicationController
  ...
  def update
    ...
    supplied_old_password = params[:old_password]
    unless real_old_password == supplied_old_password
      redirect_to users_url, notice: ":::Invalid Old Password #{real_old_password} ~~ #{supplied_old_password}"
    else
      respond_to do |format|
